...
The app will then ask the user for the year, make, model, , and type of roof and store the data in the attributes above.
...
my_car.door = input("Is the car 4 door or 2 ?: ")
...
print ("Number of doors: ",my_car.door)
